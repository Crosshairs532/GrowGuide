...
const InitializePaymentDb = (user) => __awaiter(void 0, void 0, void 0, function* () {
    const transactionID = (0, GenerateTranId_1.generate_transaction_id)(user === null || user === void 0 ? void 0 : user.name);
    if (transactionID) {
...
const paymentsDb = () => __awaiter(void 0, void 0, void 0, function* () {
    const res = yield premium_model_1.premiumModel.find().populate('userId');
    return res;
});
const paymentsChartDb = () => __awaiter(void 0, void 0, void 0, function* () {
