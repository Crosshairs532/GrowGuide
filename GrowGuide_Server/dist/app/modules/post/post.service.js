...
const getAllPostsDb = (search) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const countPosts = yield post_model_1.postModel.countDocuments(query);
    const hasMorePosts = countPosts > (Number(nextId) || 0) + res.length;
    return {
        data: res,
        nextId: hasMorePosts ? (Number(nextId) || 0) + (res === null || res === void 0 ? void 0 : res.length) : null, // Increment nextId if more posts are available
    };
});
