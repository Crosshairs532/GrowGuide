...
router.put('/profile-update', ToCloudinary_1.upload.single('file'), parseFromData_1.default, (0, auth_1.default)(['user', 'admin']), user_controller_1.userController.profileUpdate);
router.post('/follow-user', (0, auth_1.default)(['user', 'admin']), user_controller_1.userController.FollowUser);
